...
app.get('/', (req, res) => {
    res.render('Register', { err: "", errName: "", errMobile: "", errEmail: "" })
})
...
//validations
    if (name === "" || email === "" || mobile === "") {
        res.render("Register", { err: "Fufil All Fields", errName: "", errMobile: "", errEmail: "" })
    }
    else {
        if (regForName.test(name) === false) {
            res.render("Register", { errName: "Name is not Valid", err: "", errMobile: "", errEmail: "" })
        }
        else if (regForEmail.test(email) === false) {
            res.render("Register", { errEmail: "Email is not Valid", err: "", errMobile: "", errName: "" })
        }
        else if (regForMobile.test(mobile) === false) {
            res.render("Register", { errMobile: "Mobile number is not Valid", err: "", errName: "", errEmail: "" })
        }
        else {
